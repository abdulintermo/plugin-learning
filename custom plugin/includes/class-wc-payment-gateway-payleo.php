...
class WC_Gateway_Payleo extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		// $this->instructions       = "eee"; //$this->get_option( 'instructions' );
	...
	protected function setup_properties() {
		...
		// $this->api_key            = "dsffafsdf";//__( 'Add API Key', 'payleo-payments-woo' );
		// $this->widget_id          = "dsffafsdf";// __( 'Add Widget ID', 'payleo-payments-woo' );
		$this->method_description = "dsffafsdf";// __( 'Have your customers pay with Payleo Mobile Payments.', 'payleo-payments-woo' );
